...
class _SessionMetadataApi(_ApiSupport):
    ...
    def get_app_agentsessions(self, org_uuid, app_id):
        path = 'organizations/{org_uuid}/applications/{app_id}/agent-sessions'.format(org_uuid=org_uuid, app_id=app_id)
        return self._get(path)

    def filter_app_session_metadata_filter(self, org_uuid, app_id, limit=None, offset=None):
        path = 'organizations/{org_uuid}/applications/{app_id}/agent-sessions/filter'.format(org_uuid=org_uuid, app_id=app_id)
    ...
    def get_app_session_metadata_latest(self, org_uuid, app_id):
        path = 'organizations/{org_uuid}/applications/{app_id}/agent-sessions/latest'.format(org_uuid=org_uuid, app_id=app_id)
        return self._get(path)
    ...
    def filter_app_SbavRouteSession(self, org_uuid, app_id, session_id, metadata, limit=None, offset=None):
        path = 'organizations/{org_uuid}/applications/{app_id}/agent-sessions/filter'.format(org_uuid=org_uuid, app_id=app_id,  session_id=session_id, metadata=metadata)
